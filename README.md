...
4. Some configs are generated by Wallust to create dynamic color palettes.
    - Templates are stored in `./home/configs/wallust/templates` or press `SUPER+I` > go to `Extras` > `Wallust`. Here you can open the template files directly.
...
## 🚧 Currently broken
- wlogout
- fusuma (working, but not configured yet)
- HyprPanel: Updates notification icon (Need to write a script for that)
- HyprPanel: Some misaligned icons
