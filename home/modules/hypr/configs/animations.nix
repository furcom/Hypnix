  ...
  wayland.windowManager.hyprland = {
    settings = {
      animations = {
        ...
        animation = [
          "windows, 1, 6, bounce"
          "windowsIn, 1, 6, bounce, slide right"
          "windowsOut, 1, 6, bounce, popin 85%"
          "windowsMove, 1, 6, bounce, popin"
      
          "layers, 1, 6, easeOutQuint"
          "layersIn, 1, 6, easeOutQuint, popin 85%"
          "layersOut, 1, 6, easeOutQuint, fade"
          ...
          "workspacesOut, 1, 6, easeOutQuint, slide"
