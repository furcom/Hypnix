{ pkgs, ... }:
{
  ...
  programs.ssh = {
    ...
    # HomeLab
      ...
      docker-public = { user = "root"; hostname = "10.0.1.50"; port = 22; identityFile = "~/.ssh/id_ed25519"; };
      docker-private = { user = "root"; hostname = "10.0.1.55"; port = 22; identityFile = "~/.ssh/id_ed25519"; };
